# BrickByte - Architecture Issues Document

> **Project:** Real Estate Website (BrickByte)
...
| App | URL |
|-----|-----|
| **Frontend** | https://brickbyte.vercel.app |
...
|---------|-------|----------|
| Auth Token | `token` | `brickbyte_token` |
| Admin Flag | `isAdmin` | N/A |
| User Data | N/A | `brickbyte_user` |
...
|--------|------------|------|----------|
| **Option 1: Redis Cache** | Medium | ?0-1,250/mo | Multi-instance production |
...
- ✅ Service metadata (`brickbyte-api`)
...
WEBSITE_URL=https://brickbyte.vercel.app
```

        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            ...
            <p className="font-manrope font-extralight text-[#9ca3af] text-sm leading-relaxed mb-6">
              AI-powered real estate final year project connecting buyers, sellers, and admins through intelligent matching and a full MERN-style workflow.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <a href="mailto:hello@brickbyte.com" className="flex items-center gap-3 font-manrope font-extralight text-[#9ca3af] text-sm hover:text-white transition-colors">
                  <Mail className="w-5 h-5 flex-shrink-0 text-[#D4755B]" />
                  <span>hello@brickbyte.com</span>
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-[rgba(255,255,255,0.1)] pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="font-manrope font-extralight text-[#6b7280] text-sm text-center md:text-left">
              © 2026 BrickByte. Final Year Project. Powered by AI.
            </p>

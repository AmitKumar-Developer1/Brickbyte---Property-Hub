        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <Link to="/" className="flex items-center gap-3 mb-6">
              <img src="/logo.png" alt="BrickByte" className="h-10 w-auto brightness-0 invert" />
              <span className="font-fraunces text-2xl font-bold">BrickByte</span>
            </Link>
            <p className="font-manrope font-extralight text-[#9ca3af] text-sm leading-relaxed mb-6">
              Final year engineering project demonstrating property listings, user authentication, admin review, and a MERN-style workflow.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <a href="https://maps.google.com/?q=Kit%20Kanpur%2C%20Rooma%2C%20Kanpur%20Nagar" target="_blank" rel="noopener noreferrer" className="flex items-start gap-3 font-manrope font-extralight text-[#9ca3af] text-sm hover:text-white transition-colors group">
              ...
              <li>
                <a href="tel:+916393054957" className="flex items-center gap-3 font-manrope font-extralight text-[#9ca3af] text-sm hover:text-white transition-colors">
                  <Phone className="w-5 h-5 flex-shrink-0 text-[#D4755B]" />
                  <span>6393054957</span>
                </a>
              </li>
              <li>
                <a href="mailto:amitsse11@gmail.com" className="flex items-center gap-3 font-manrope font-extralight text-[#9ca3af] text-sm hover:text-white transition-colors">
                  <Mail className="w-5 h-5 flex-shrink-0 text-[#D4755B]" />
                  <span>amitsse11@gmail.com</span>
                </a>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <p className="font-manrope font-extralight text-[#9ca3af] text-sm mb-4 leading-relaxed">
              Subscribe to receive project updates, sample listings, and feature notes.
            </p>
        ...
        <div className="border-t border-[rgba(255,255,255,0.1)] pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="font-manrope font-extralight text-[#6b7280] text-sm text-center md:text-left">
              © 2026 BrickByte. Final Year Project.
            </p>

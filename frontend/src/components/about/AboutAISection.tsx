        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <p className="font-manrope font-extralight text-lg leading-[29.25px] text-[#4b5563] mb-8">
              This project module combines listing data, filters, location details,
              and generated summaries to demonstrate how assisted search can improve
              a real estate browsing workflow.
            </p>

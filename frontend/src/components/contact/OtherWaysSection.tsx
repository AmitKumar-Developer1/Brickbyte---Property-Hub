  ...
  const methods: ContactMethod[] = [
    {
      ...
      action: 'Start Chat',
      actionLink: 'https://wa.me/916393054957',
      bgColor: 'bg-[#E8F5E9]'
    },
    {
      icon: 'chat_bubble',
      title: 'Live Chat',
      description: 'Open the demo chat entry point for support-related project flow testing.',
      action: 'Launch Chat',
      actionLink: '#',
      bgColor: 'bg-[#E3F2FD]'
    },
    {
      ...
      description: 'Submit a request that can be handled through the project workflow.',
      action: 'Book Now',
      actionLink: '#',
      bgColor: 'bg-[#FFF3E0]'
    }

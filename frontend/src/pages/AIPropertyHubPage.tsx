  ...
  const features = [
    {
      ...
      description: 'Search sample listings across cities with filters for budget, property type, and category.',
    },
    {
      icon: 'analytics',
      title: 'Market Analysis',
      description: 'Review generated comparisons, value notes, and listing recommendations.',
    },
    {
      icon: 'trending_up',
    ...
    },
    {
      icon: 'lightbulb',
      title: 'Demo Notes',
      description: 'Generate project demo notes from market data and location analysis.',
    },
  ];
        ...
        <div className="max-w-[1280px] mx-auto px-8 pt-32 pb-20 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="font-manrope text-lg text-[#9ca3af] leading-relaxed mb-10 max-w-2xl mx-auto">
              The AI Property Hub demonstrates assisted real estate search, listing comparison,
              and sample property analysis. This feature is available when you run the project locally.
            </p>
            ...
            <div className="bg-[rgba(212,117,91,0.1)] border border-[rgba(212,117,91,0.25)] rounded-2xl p-6 max-w-xl mx-auto">
              <div className="flex items-start gap-3">
                ...
                <p className="font-manrope text-sm text-[#d1c4b7] text-left leading-relaxed">
                  This module requires API credits to operate. To keep the deployed project lightweight, it can
                  be disabled on the live site. Clone the repo and run it locally to test the complete module.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="max-w-[1280px] mx-auto px-8 py-20">
        <div className="text-center mb-14">
          ...
          <p className="font-manrope text-[#6b7280] max-w-xl mx-auto">
            These assisted-search features are available when the project is run on your machine.
          </p>
        </div>
      ...
      <section className="bg-[#F5F1E8] py-20">
        <div className="max-w-[1280px] mx-auto px-8">
          <div className="text-center mb-14">
            ...
            <p className="font-manrope text-[#6b7280] max-w-xl mx-auto">
              Set up the project locally and test the assisted-search module.
            </p>
          </div>
...
const AIPropertyHubPage: React.FC = () => {
  useSEO({
    ...
    description: 'Assisted property search, listing comparison, location trends, and project demo analysis for Indian real estate.',
  });

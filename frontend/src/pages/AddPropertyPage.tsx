...
const AddPropertyPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSubmitted(true);
      toast.success('Listing published! It is now live on the properties page.');
    } catch (err: any) {
      ...
      <div className="min-h-screen bg-[#FAF8F4]">
        ...
        <div className="max-w-xl mx-auto px-4 py-24 text-center">
          ...
          <p className="font-manrope text-[#6B7280] mb-8">
            Your property listing is now live and visible on the properties page.
          </p>
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="mb-10">
          ...
          <p className="font-manrope text-[#6B7280]">
            Fill in the details below. Once submitted, your listing will be published immediately.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          <div className="flex items-start gap-3 bg-green-50 border border-green-200 rounded-xl p-4">
            ...
            <p className="font-manrope text-sm text-green-800">
              Your listing will appear publicly as soon as it is submitted. You can manage or remove it anytime from My Listings.
            </p>
          </div>

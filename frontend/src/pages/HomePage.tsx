...
const HomePage: React.FC = () => {
  useSEO({
    title: 'Real Estate Final Year Project',
    description: 'BrickByte is a final year engineering project with property listings, authentication, admin review, and optional assisted search modules.',
  });
